...
const article: Article = {
  ...
  keyword: "qazaxıstanda təhsil",
  title: "Qazaxıstanda Təhsil 2026: Universitetlər, Qəbul Şərtləri və Xərclər",
  relatedCountrySlug: "qazaxistan",
  metaDescription:
    "Qazaxıstanda təhsil: Almatı və Astana universitetləri, Nazarbayev Universiteti, attestatla qəbul, ingilis dilində proqramlar, xərclər və viza. MegaGroup-dan tam bələdçi.",
  keywords: [
    "qazaxıstanda təhsil",
    "qazaxistanda tehsil",
  ...
  intro: [
    ...
    "MegaGroup olaraq 2018-ci ildən fəaliyyət göstəririk və 1000-dən çox tələbəni 200-dən artıq universitetə yerləşdirmişik. Bu bələdçidə Qazaxıstanda təhsilin bütün əsas məqamlarını izah edirik.",
  ],
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Yaşayış xərcləri Mərkəzi Asiya regionunda əlçatan səviyyədədir və tələbələr üçün güclü dövlət dəstəyi proqramları mövcuddur.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Tələb olunan əsas sənədlər: attestat (notarial tərcümə ilə), pasport, şəkil və bəzi hallarda dil sertifikatı.",
      ],
    },
    {
      ...
      list: [
        "Nazarbayev Universiteti (Astana) — Qazaxıstanın ən prestijli universiteti, tam ingilis dilində təhsil, dünya standartları. İllik təhsil haqqı: ~$4,000-8,000.",
        "Kazakh National University (Al-Farabi KazNU, Almatı) — Qazaxıstanın ən böyük klassik universiteti, geniş ixtisas seçimi.",
        "Kazakh-British Technical University (KBTU, Almatı) — Ingilis dilində mühəndislik və IT proqramları.",
        "KIMEP University (Almatı) — Biznes, iqtisadiyyat və sosial elmlər üzrə ingilis dilində təhsil.",
        "International Information Technology University (IITU, Almatı) — IT və kompüter elmləri.",
        "Astana Medical University — Tibb ixtisası, ingilis və rus dilində proqramlar.",
      ],
    },
    {
      ...
      list: [
        ...
        "Neft-qaz Mühəndisliyi (xüsusilı Maıngıstaw və Atraı bölgesinde)",
        "Beynəlxalq Münasibətlər və Diplomatiya",
        "Tibb və Səhiyyə İdarəetməsi",
        "Biznes və İqtisadiyyat",
        "Hüquq (beynəlxalq hüquq istiqamətində)",
      ],
    },
    {
      ...
      table: {
        headers: ["Xərc kateqoriyası", "Almatı (aylıq)", "Astana (aylıq)"],
        rows: [
          ["Yataqxana / kirayə mənzil", "$80-200", "$100-250"],
          ["Qida", "$80-120", "$80-120"],
          ["Nəqliyyat", "$10-20", "$10-20"],
          ["Ümumi aylıq yaşayış", "$170-340", "$190-390"],
        ],
      },
    },
    {
  ...
  faqs: [
    {
      ...
      answer:
        "Universitetdən asılı olaraq tədris rus, qazax və ya ingilis dilində aparılır. Nazarbayev Universiteti, KBTU və KIMEP kimi universitetlərdə proqramlar tam ingilis dilindədir.",
    },
    {
      question: "Qazaxıstan universitet diplomu Azərbaycanda tanınırmı?",
      answer:
        "Bəli, akkreditəli dövlət və özəl universitetlərin diplomları Azərbaycanda tanınır və ekvivalentləşdirilə bilər.",
    },
    {
    ...
    {
      question: "Qazaxıstanda yaşayış xərcləri nə qədərdir?",
      answer:
        "Almatıda aylıq ümumi yaşayış xərci təxminən 170-340 dollar, Astanada isə 190-390 dollar aralığındadır.",
    },
    {
      question: "Nazarbayev Universitetinə qəbul üçün nə lazımdır?",
      answer:
        "Yüksək attestat ortalaması, IELTS/TOEFL sertifikatı və motivasiya məktubu tələb olunur. Rəqabət yüksəkdir, lakin tam ingilis dilində dünya səviyyəli təhsil təklif edir.",
    },
  ],
