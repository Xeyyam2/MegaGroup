...
const article: Article = {
  ...
  title: "Rusiyada Təhsil 2026: Qəbul, Universitetlər və Xərclər",
  metaDescription:
    "Rusiyada təhsil haqqında tam bələdçi: ən yaxşı universitetlər, attestatla qəbul, tibb və mühəndislik proqramları, xərclər, viza və nostrifikasiya — MegaGroup.",
  keywords: [
    "rusiyada təhsil",
    "rusiyada tehsil",
  ...
  intro: [
    "Rusiyada təhsil almaq onilliklərdir ki, azərbaycanlı tələbələr üçün ənənəvi və etibarlı seçimlərdən biri olub. Geniş universitet şəbəkəsi, güclü akademik ənənə və tanış rus dili bu ölkəni xüsusilə tibb, mühəndislik və təbiət elmləri ixtisaslarını düşünən abituriyentlər üçün cəzbedar edir. Bu bələdçidə rusiyada təhsilin bütün tərəflərini — qəbul şərtlərindən başlayaraq xərclər, viza və diplomun tanınmasına qədər — real rəqəmlərlə və konkret nümunələrlə izah edirik.",
    "MegaGroup olaraq 2018-ci ildən fəaliyyət göstərir və bu müddətdə 1000-dən çox azərbaycanlı tələbəni Rusiyanın 200-dən artıq universitetinə uğurla yerləşdirmişik. Komandamız Moskva, Sankt-Peterburq, Kazan, Voronej və Rostov kimi şəhərlərdəki tərəfdaş universitetlərlə birbaşa əlaqə saxlayır və sizə attestatla, imtahansız qəbul prosesində başdan-ayağa dəstək olur. Aşağıdakı məlumatlar təcrübəli ekspertlərimizin real praktikasına əsaslanır.",
  ],
  sections: [
    {
    ...
    },
    {
      ...
      list: [
        "Moskva Dövlət Universiteti (MSU) — ölkənin ən nüfuzlu universiteti, 40+ fakültə və güclü təbiət elmləri.",
        "Sankt-Peterburq Dövlət Universiteti (SPbSU) — tarix, hüquq və Şərqşünaslıq üzrə lider.",
        "Rusiya Xalqların Dostluq Universiteti (RUDN) — ən beynəlmiləl kampus, 160+ ölkədən tələbə.",
        "Kazan Federal Universiteti — təbiət elmləri və tibbdə güclü, müsəlman-dostu mühit.",
        "İ.M. Seçenov Birinci Moskva Dövlət Tibb Universiteti — Rusiyanın ən qədim tibb universiteti.",
        "ITMO Universiteti və Yüksək İqtisadiyyat Məktəbi (HSE) — IT, süni intellekt və iqtisadiyyatda liderlər.",
      ],
    },
    {
    ...
    },
    {
      ...
      list: [
        "Orta məktəb attestatı (notarial tərcümə ilə, bəzi hallarda apostil tələb olunur)",
        "Beynəlxalq pasport (etibarlılıq müddəti ən azı 1,5 il olmalıdır)",
        "Doğum şəhadətnaməsinin tərcüməsi",
        "Tibbi arayış (HİV, hepatit, vərəm üzrə mənfi nəticələr)",
        "6 ədəd 3x4 sm ölçüdə rəngli fotoşəkil",
        "Motivasiya məktubu (bəzi universitet və ixtisaslar üçün)",
      ],
    },
    {
      ...
      table: {
        ...
        rows: [
          ["Moskva", "3 500 – 7 000", "30 – 120", "400 – 700"],
          ["Sankt-Peterburq", "3 000 – 6 000", "25 – 100", "350 – 600"],
          ["Kazan", "2 000 – 4 000", "20 – 80", "250 – 400"],
          ["Voronej / Rostov", "1 800 – 3 500", "15 – 60", "200 – 350"],
    ...
    },
    {
      ...
      list: [
        "1. Pulsuz konsultasiya — büdcənizə və ixtisasınıza uyğun universitet və şəhərin seçilməsi.",
        "2. Sənədlərin hazırlanması — attestatın tərcüməsi, notarius təsdiqi və apostil prosedurası.",
        "3. Universitetə müraciət — onlayn formata və ya Rossotrudniçestvo vasitəsilə kvota üçün yarışma.",
        "4. Qəbul qərarı və rəsmi dəvət məktubunun (priglaşeniye) alınması.",
        "5. Dəvət məktubu əsasında tələbə vizası üçün konsulluğa müraciət.",
        "6. Biletlərin alınması və yataqxanada yerin vaxtında bronlaşdırılması.",
        "7. Rusiyaya gəliş, universitetdə akademik qeydiyyat və tədris ilinin başlaması.",
      ],
    },
    {
  ...
  faqs: [
    {
      question: "Rusiyada təhsil üçün DİM imtahanı verməliyəm?",
      answer:
        "Xeyr. Rusiya universitetləri xarici tələbələrdən YEGE və ya DİM tipli mərkəzləşdirilmiş imtahan tələb etmir. Qəbul attestat qiymətləri əsasında aparılır; yalnız bəzi rəqabətli ixtisaslarda əlavə onlayn müsahibə və ya test ola bilər.",
    },
    {
      question: "Rusiyada tibb təhsili neçə il davam edir?",
      answer:
        "Ümumi təhsil (leçebnoye delo) ixtisası 6 il, stomatologiya 5 il, əczaçılıq isə 5 il davam edir. Məzun olmaq üçün dövlət imtahanı və akkreditasiya verilir, bundan sonra 2-4 illik klinik ordinatura (rezidentura) proqramına davam etmək mümkündür.",
    },
    {
      question: "Moskvada aylıq yaşayış neçəyə başa gəlir?",
      answer:
        "Moskvada tələbə üçün aylıq ümumi yaşayış xərci orta hesabla 400-700 dollar civarındadır (yataqxana, qida, nəqliyyat). Yataqxanada yerləşsəniz xərc aşağı düşər; icarə mənzil isə xeyli baha başa gəlir.",
    },
    {
      question: "Rus dilini bilmədən rusiyada oxumaq olarmı?",
      answer:
        "Bəli. Rus dilini bilməyənlər üçün bir illik hazırlıq fakültəsi (podfak) mövcuddur. Bundan əlavə, Seçenov, Piroqov, HSE və ITMO kimi universitetlərdə tam ingilis dilində proqramlar seçmək mümkündür.",
    },
    {
      question: "Rusiya diplomu Azərbaycanda tanınırmı?",
      answer:
        "Bəli, dövlət akkreditasiyalı rusiya universitetlərinin diplomları tanınır. Rəsmi iş üçün nostrifikasiya (ekvivalentləşdirmə) prosedurası keçilməli olur; bu proses 1-3 ay çəkir və Bolonya sazişi səbəbilə sadələşib.",
    },
    {
      question: "Tələbə vizası prosesi nə qədər vaxt aparır?",
      answer:
        "Universitetdən dəvət məktubu (priglaşeniye) gəldikdən sonra viza 3-6 həftəyə hazırlanır. İlk viza 90 günlükdür, Rusiyaya gəldikdən sonra 1 illik tələbə vizasına uzadılır. MegaGroup bu prosesdə addım-addım kömək edir.",
    },
    {
      question: "Hazırlıq ili (podfak) mütləqdir?",
      answer:
        "Yalnız rus dilində təhsil almaq istəyib dili bilməyənlər üçün. Hazırlıq ili rus dilini və ixtisas fənlərini intensiv öyrədir, sonra birinci kursa keçid olur. İngilis proqramı seçsəniz podfaka ehtiyac qalmır.",
    },
    {
      question: "MegaGroup-un xidməti pulludurmu?",
      answer:
        "İlkin konsultasiya, universitet və şəhər seçimi tam pulsuzdur. Sənəd hazırlığı, universitetə müraciət və viza dəstəyi üçün xidmət paketi müraciət zamanı dəqiqləşdirilir. 2018-ci ildən 1000+ tələbə yerləşdirmiş təcrübəli komandadayıq.",
    },
  ],
