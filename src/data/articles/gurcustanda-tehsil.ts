...
const article: Article = {
  ...
  metaDescription:
    "Gürcüstanda təhsil: Tbilisi və Batumi universitetləri, ingilis dilində tibb proqramları, attestatla qəbul, xərclər və viza. MegaGroup-dan tam bələdçi.",
  keywords: [
    "gürcüstanda təhsil",
    "gurcustanda tehsil",
    "tbilisidə təhsil",
    ...
    "batumidə təhsil",
    "gürcüstanda ingilis dilində tibb",
  ],
  excerpt:
  ...
  intro: [
    ...
    "MegaGroup olaraq 2018-ci ildən xaricdə təhsil sahəsində fəaliyyət göstəririk və bu müddətdə 1000-dən çox tələbəni 200-dən artıq universitetə yerləşdirmişik. Gürcüstan bu istiqamətlərdən biridir və bu bələdçidə gürcüstanda təhsilin bütün detallarını sizinlə paylaşırıq.",
  ],
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Üçüncüsü və ən vacibi: Gürcüstanın tibb universitetləri ECFMG (Educational Commission for Foreign Medical Graduates) tərəfindən tanınır. Bu o deməkdir ki, məzunlar ABŞ-da USMLE imtahanı verə bilər və Avropada təcrübə keçə bilərlər.",
      ],
    },
    {
    ...
    },
    {
      ...
      list: [
        "Tbilisi Dövlət Tibb Universiteti (TSMU) — Gürcüstanın ən köhnə və ən nüfuzlu tibb universiteti. Ingilis dilində 6 illik ümumi tibb proqramı. İllik təhsil haqqı: ~$4,000-6,000.",
        "European University Tbilisi — ingilis dilində tibb proqramı, müasir kampus. İllik təhsil haqqı: ~$3,500-5,000.",
        "AIETI Medical School — TSMU ilə əlaqəli, yüksək keyfiyyətli tibb təhsili. İllik təhsil haqqı: ~$4,000-5,500.",
        "Caucasus University — Biznes, Hüquq, IT ixtisaslarında güclü proqramlar. İllik təhsil haqqı: ~$3,000-4,500.",
        "Tbilisi State University — Gürcüstanın ən böyük klassik universiteti, geniş ixtisas seçimi.",
        "Batumi Shota Rustaveli State University — Batumidə, daha ucuz yaşayış, tibb və humanitar ixtisaslar.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Tibb proqramı 6 il davam edir və məzunlara MD (Medical Doctor) dərəcəsi verilir. Son 2 ildə klinik təcrübə Gürcüstanın aparıcı xəstəxanalarında keçirilir.",
      ],
    },
    {
      ...
      table: {
        headers: ["Xərc kateqoriyası", "Tbilisi (aylıq)", "Batumı (aylıq)"],
        rows: [
          ["Yataqxana / kirayə mənzil", "$150-300", "$100-250"],
          ["Qida", "$100-150", "$80-120"],
          ["Nəqliyyat (metro, avtobus)", "$10-15", "$10-15"],
          ["Sığorta və digər", "$20-30", "$20-30"],
          ["Ümumi aylıq yaşayış", "$280-495", "$210-415"],
        ],
      },
    },
    {
  ...
  faqs: [
    {
      ...
      answer:
        "Bəli, Tbilisi Dövlət Tibb Universiteti və digər aparıcı universitetlərdə ümumi tibb proqramı tam ingilis dilində tədris olunur. Bu, beynəlxalq tələbələr üçün əsas üstünlükdür.",
    },
    {
      question: "Gürcüstan universitet diplomu beynəlxalq səviyyədə tanınırmı?",
      answer:
        "Bəli, xüsusilə tibb universitetlərinin diplomları ECFMG/WFME siyahısındadır və ABŞ, Böyük Britaniya və Avropa ölkələrində tanınır. Diplomlar Azərbaycanda da ekvivalentləşdirilir.",
    },
    {
      question: "Gürcüstana viza lazımdırmı?",
      answer:
        "Azərbaycan vətəndaşları üçün 1 ilə qədər vizasız rejim mövcuddur. Lakin tələbə statusu üçün yaşayış icazəsi (residence permit) almaq lazımdır.",
    },
    {
      question: "Gürcüstanda aylıq yaşayış xərci nə qədərdir?",
      answer:
        "Tbilisidə aylıq ümumi yaşayış xərci (yataqxana, qida, nəqliyyat) təxminən 300-500 dollar, Batumidə isə 250-400 dollar aralığındadır.",
    },
    {
      question: "Gürcüstanda tibb təhsili neçə il davam edir?",
      answer:
        "Ümumi tibb (MD) proqramı 6 il davam edir. İngilis dilində tədris olunan proqramların son 2 ili klinik təcrübəni əhatə edir.",
    },
    {
      question: "MegaGroup gürcüstanda qəbul prosesində kömək edirmi?",
      answer:
        "Bəli, MegaGroup universitet seçimi, sənəd hazırlığı, müraciət və yaşayış icazəsi prosesində tam dəstək göstərir. İlk konsultasiya pulsuzdur.",
    },
  ],
