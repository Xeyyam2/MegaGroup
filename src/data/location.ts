...
//
// QEYS: əvvəl xəritə "refused to connect" verirdi — səbəb Google yox,
// saytın Cross-Origin-Embedder-Policy: credentialless header-i idi ki, o da
// üçüncü tərəf iframe-ləri bloklayır. COEP silindi, indi Embed API işləyir.
